...
public:
    ...
    mapOptimization()
    {
        ...
        pubKeyPoses                 = nh.advertise<sensor_msgs::PointCloud2>("tdar_lio_sam/mapping/trajectory", 1);
        pubLaserCloudSurround       = nh.advertise<sensor_msgs::PointCloud2>("tdar_lio_sam/mapping/map_global", 1);
        pubLaserOdometryGlobal      = nh.advertise<nav_msgs::Odometry> ("tdar_lio_sam/mapping/odometry", 1);
        pubLaserOdometryIncremental = nh.advertise<nav_msgs::Odometry> ("tdar_lio_sam/mapping/odometry_incremental", 1);
        pubPath                     = nh.advertise<nav_msgs::Path>("tdar_lio_sam/mapping/path", 1);

        subCloud = nh.subscribe<tdar_lio_sam::cloud_info>("tdar_lio_sam/feature/cloud_info", 1, &mapOptimization::laserCloudInfoHandler, this, ros::TransportHints().tcpNoDelay());
        subGPS   = nh.subscribe<nav_msgs::Odometry> (gpsTopic, 200, &mapOptimization::gpsHandler, this, ros::TransportHints().tcpNoDelay());
        subLoop  = nh.subscribe<std_msgs::Float64MultiArray>("lio_loop/loop_closure_detection", 1, &mapOptimization::loopInfoHandler, this, ros::TransportHints().tcpNoDelay());

        srvSaveMap  = nh.advertiseService("tdar_lio_sam/save_map", &mapOptimization::saveMapService, this);

        pubHistoryKeyFrames   = nh.advertise<sensor_msgs::PointCloud2>("tdar_lio_sam/mapping/icp_loop_closure_history_cloud", 1);
        pubIcpKeyFrames       = nh.advertise<sensor_msgs::PointCloud2>("tdar_lio_sam/mapping/icp_loop_closure_corrected_cloud", 1);
        pubLoopConstraintEdge = nh.advertise<visualization_msgs::MarkerArray>("/tdar_lio_sam/mapping/loop_closure_constraints", 1);

        pubRecentKeyFrames    = nh.advertise<sensor_msgs::PointCloud2>("tdar_lio_sam/mapping/map_local", 1);
        pubRecentKeyFrame     = nh.advertise<sensor_msgs::PointCloud2>("tdar_lio_sam/mapping/cloud_registered", 1);
    ...
    bool saveMapService(tdar_lio_sam::save_mapRequest& req, tdar_lio_sam::save_mapResponse& res)
    {
    ...
    void visualizeGlobalMapThread()
    {
        ...
        tdar_lio_sam::save_mapRequest  req;
        tdar_lio_sam::save_mapResponse res;
    ...
    void publishFrames()
    {
        ...
        if (pubSLAMInfo.getNumSubscribers() != 0)
        {
            ...
            {
                tdar_lio_sam::cloud_info slamInfo;
